...
public class CircleVertex implements Vertex {
	...
	public CircleVertex(double centerX, double centerY, double radius, Paint fill, int number) {
		circle = new Circle(centerX, centerY, radius, fill);
		this.number = number;
	}
	
	public CircleVertex(double centerX, double centerY, double radius, Paint fill) {
		circle = new Circle(centerX, centerY, radius, fill);
	}
